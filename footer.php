<div class="footer"> 
   ...
   <div class="footer-item footer-item-right">
        ...
        <ul class="cat">
           <li id="topic"><?php _e('Categories'); ?>: </li>
            <?php wp_list_categories('title_li='); ?>
        </ul>
    </div>
    <div class="footer-item footer-item-left"> 
        <ul class="cat">
           <li id="topic">در وب: </li>
           <?php
                ...
                if($first_footer_link != null && $first_footer_link_text != null){
                    echo '<li class="cat-item"><a href="'. $first_footer_link. '"> '.$first_footer_link_text. ' </a><span> | </span></li>';
                }
                ...
                if($second_footer_link != null && $second_footer_link_text != null){
                    echo '<li class="cat-item"><a href="'. $second_footer_link. '"> '.$second_footer_link_text. ' </a><span> | </span></li>';
                }
                ...
                if($third_footer_link != null && $third_footer_link_text != null){
                    echo '<li class="cat-item"><a href="'. $third_footer_link. '"> '.$third_footer_link_text. ' </a><span> | </span></li>';
                }
                ...
                if($fourth_footer_link != null && $fourth_footer_link_text != null){
                    echo '<li class="cat-item"><a href="'. $fourth_footer_link. '"> '.$fourth_footer_link_text. ' </a><span> | </span></li>';
                }
                ...
                if($fifth_footer_link != null && $fifth_footer_link_text != null){
                    echo '<li class="cat-item"><a href="'. $fifth_footer_link. '"> '.$fifth_footer_link_text. ' </a><span> | </span></li>';
                }
                ...
                if($sixthfirst_footer_link != null && $sixth_footer_link_text != null){
                    echo '<li class="cat-item"><a href="'. $sixth_footer_link. '"> '.$sixth_footer_link_text. ' </a><span> | </span></li>';
                }
                ...
                if($seventh_footer_link != null && $seventh_footer_link_text != null){
                    echo '<li class="cat-item"><a href="'. $seventh_footer_link. '"> '.$seventh_footer_link_text. ' </a><span> | </span></li>';
                }
...
<div class="copyright-stuff"> 
    <p>کپی‌رایت 2015، طراحی شده توسط :<a href="http://ysarbabi.ir"> یحیی صیاداربابی </a>.</p> 
