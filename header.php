                ...
                <p class="header-links"><span> </span> 
                    ...
                    <?php
                        ...
                        if($second_header_url != null && $second_header_url_text != null){
                            echo '<span> | </span><a href="'. $second_header_url. '"> ' .$second_header_url_text. ' </a>';
                        }
                        ...
                        if($third_header_url != null && $third_header_url_text != null){
                            echo '<span> | </span><a href="'. $third_header_url. '"> '.$third_header_url_text. ' </a>';
                        }
                        ...
                        if($fourth_header_url != null && $fourth_header_url_text != null){
                            echo '<span> | </span><a href="'. $fourth_header_url. '"> '.$fourth_header_url_text. ' </a>';
                        }
                        ...
                        if($fifth_header_url != null && $fifth_header_url_text != null){
                            echo '<span> | </span><a href="'. $fifth_header_url. '"> '.$fifth_header_url_text. ' </a>';
                        }
                    ?>
